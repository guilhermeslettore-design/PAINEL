...
(function () {
  ...
  const PERGUNTAS = {
    quiz1: [
      { p: "Quem criou o Claude?", o: ["Anthropic", "OpenAI", "Google", "Meta"], c: 0,
        e: "O Claude é da Anthropic, empresa focada em segurança de IA fundada em 2021." },
      { p: "O que é um 'token'?", o: ["A unidade de texto que a IA lê e escreve", "A senha que dá acesso à sua conta", "Cada modelo da família Claude", "A moeda usada para pagar a API"], c: 0,
        e: "Token é a unidade de texto da IA — uma palavra tem em média 1 a 3 tokens." },
      { p: "Qual modelo é o mais rápido e barato da família?", o: ["Haiku 4.5", "Sonnet 4.6", "Opus 4.8", "Fable 5"], c: 0,
        e: "O Haiku é o 'motoboy': ideal para tarefas simples e em grande volume." },
      { p: "Para escrever um e-mail ou revisar um texto do dia a dia, por onde começar?", o: ["Sonnet, equilíbrio de custo e qualidade", "Fable, por ser o mais inteligente de todos", "Haiku, por ser o mais barato de todos", "Opus, por encarar qualquer tarefa"], c: 0,
        e: "Regra de bolso: comece pelo Sonnet; desça pro Haiku se for simples, suba pro Opus se for complexo." },
      { p: "O que faz o 'pensamento estendido'?", o: ["Faz o Claude raciocinar mais antes de responder", "Aumenta o limite de mensagens do seu plano", "Traduz a resposta para outro idioma", "Salva a conversa no seu histórico"], c: 0,
        e: "Com o modo de raciocínio ligado, o Claude pensa por mais tempo — ótimo para problemas difíceis." },
      { p: "Qual a 'janela de contexto' de modelos como o Sonnet 4.6?", o: ["1 milhão de tokens", "200 mil tokens", "128 mil tokens", "10 mil tokens"], c: 0,
        e: "Sonnet, Opus e Fable trabalham com até 1 milhão de tokens; o Haiku, 200 mil. (200 mil é a pegadinha!)" },
      { p: "No claude.ai (site/app), você paga…", o: ["Uma assinatura (ou usa o plano grátis)", "Por token de entrada e de saída", "Por cada conversa iniciada", "Por cada modelo que baixar"], c: 0,
        e: "Assinatura é no claude.ai; pagar por token é só na API, para desenvolvedores." },
      { p: "A IA 'alucinou'. O que isso significa?", o: ["Inventou uma informação com confiança", "Travou e parou de responder", "Repetiu a mesma resposta", "Trocou de idioma sozinha"], c: 0,
        e: "Alucinação é quando a IA afirma algo falso com convicção — por isso, confira dados importantes." },
      { p: "Qual hábito melhora a qualidade das respostas?", o: ["Manter um assunto por conversa", "Misturar vários assuntos na mesma conversa", "Escrever sempre em inglês", "Usar frases curtas, de uma palavra"], c: 0,
        e: "Um assunto = uma conversa. Contexto focado gera resposta focada." },
      { p: "O que é o Fable 5?", o: ["O modelo mais avançado, da família Claude 5", "Um dos planos de assinatura do claude.ai", "Um conector para ligar o Claude a apps", "O aplicativo de desktop do Claude"], c: 0,
        e: "Fable 5 é o topo de linha — primeiro modelo da família Claude 5, para os problemas mais difíceis." },
      { p: "Você precisa classificar 5.000 mensagens como 'elogio' ou 'reclamação'. Qual modelo?", o: ["Haiku, rápido e barato para grande volume", "Opus, por ser o mais inteligente", "Fable, já que custo não importa", "Sonnet, por ser o mais equilibrado"], c: 0,
        e: "Tarefa simples em grande volume é a especialidade do Haiku: rápido e econômico." },
      { p: "Qual destes prompts tende a gerar a MELHOR resposta?", o: ["'Escreva um folheto de adoção de cães em 3 parágrafos, tom emocional'", "'Escreva algo bom sobre adoção de cachorros'", "'Faça um texto sobre cães para adoção'", "'Crie um folheto de adoção bem caprichado'"], c: 0,
        e: "Contexto + formato (3 parágrafos) + tom (emocional) vencem. 'Bom' e 'caprichado' não dizem nada à IA." },
      { p: "A Anthropic foi fundada em que ano?", o: ["2021", "2015", "2024", "2018"], c: 0,
        e: "A Anthropic foi fundada em 2021, com foco em segurança de IA." },
      { p: "Você quer uma resposta rápida e não precisa de raciocínio profundo. O que fazer?", o: ["Desligar o pensamento estendido", "Ligar o pensamento estendido", "Trocar para um modelo maior", "Ativar a pesquisa na web"], c: 0,
        e: "Pensamento estendido desligado = respostas mais rápidas, ideal para perguntas simples." },
      { p: "Aproximadamente quantos tokens tem a palavra 'computador'?", o: ["Entre 1 e 3 tokens", "Exatamente 1 token", "Cerca de 10 tokens", "Mais de 50 tokens"], c: 0,
        e: "Em média uma palavra tem de 1 a 3 tokens." },
      { p: "Onde você NÃO paga por token, e sim assinatura fixa?", o: ["No claude.ai (site e aplicativos)", "Na API da Anthropic", "No Claude Code via chave de API", "No console de desenvolvedor"], c: 0,
        e: "No claude.ai você paga assinatura. Pagar por token é só na API." },
      { p: "Você está num problema difícil de matemática. Qual recurso ajuda mais?", o: ["O pensamento estendido (modo de raciocínio)", "A pesquisa na web para achar a fórmula", "A memória entre conversas", "O modo de voz do aplicativo"], c: 0,
        e: "Para lógica e cálculo, ligue o pensamento estendido — ele raciocina com mais cuidado." },
      { p: "Por que começar uma conversa nova para cada assunto?", o: ["Para manter o contexto focado e a resposta melhor", "Para gastar menos bateria do aparelho", "Porque o app obriga a cada assunto", "Para deixar o histórico mais bonito"], c: 0,
        e: "Um assunto por conversa mantém o contexto limpo e as respostas mais precisas." },
      { p: "O que fazer com uma informação importante que a IA te deu?", o: ["Conferir, porque a IA pode ter alucinado", "Confiar 100%, a IA não erra nisso", "Ignorar e procurar em outro lugar", "Apagar a conversa por segurança"], c: 0,
        e: "A IA pode inventar com confiança. Sempre confira dados importantes." },
    ],
    quiz2: [
      { p: "O que é um Projeto no claude.ai?", o: ["Uma pasta inteligente com instruções e arquivos fixos", "Um modelo de IA treinado por você", "Um plano pago com mais recursos", "Um arquivo de código gerado pelo Claude"], c: 0,
        e: "Projetos agrupam conversas e dão ao Claude instruções e conhecimento permanentes sobre um tema." },
      { p: "O que são Artifacts?", o: ["Painéis com produtos prontos: docs, sites e mini-apps", "Plugins pagos que você instala no Claude", "Backups automáticos das suas conversas", "Mensagens de erro do sistema"], c: 0,
        e: "Quando você pede algo 'pronto' (um app, um documento), o Claude monta num painel editável ao lado do chat." },
      { p: "O MCP (Model Context Protocol) serve para…", o: ["Conectar o Claude a ferramentas e dados externos", "Acelerar as respostas reduzindo o uso de tokens", "Criar memória permanente entre todas as conversas", "Proteger a conta com uma camada extra de senha"], c: 0,
        e: "MCP é o 'USB das IAs': padrão aberto da Anthropic que liga ferramentas (Drive, GitHub…) ao Claude." },
      { p: "Onde você ativa um conector no claude.ai?", o: ["Em Configurações → Conectores", "Na loja de aplicativos do celular", "Pedindo diretamente no chat", "No site da própria ferramenta"], c: 0,
        e: "Settings/Configurações → Conectores: escolha no diretório, conecte e autorize." },
      { p: "Com o conector do Google Drive ativo, o que faz sentido pedir?", o: ["'Resuma o documento X que está no meu Drive'", "'Instale um programa novo no meu computador'", "'Aumente a velocidade da minha internet'", "'Formate o meu disco rígido'"], c: 0,
        e: "O conector dá ao Claude acesso de leitura ao Drive — sempre com sua autorização; ele não mexe no seu sistema." },
      { p: "Como adicionar um conector que não está no diretório?", o: ["Pela URL do servidor MCP, em 'conector personalizado'", "Baixando um instalador .exe do site dele", "Enviando um pedido por e-mail à Anthropic", "Não é possível, só os do diretório funcionam"], c: 0,
        e: "Se a ferramenta tem servidor MCP, dá para adicionar pela URL em Configurações → Conectores." },
      { p: "Qual técnica melhora MUITO um prompt profissional?", o: ["Definir um papel (persona) e mostrar exemplos", "Escrever o pedido todo em letras maiúsculas", "Repetir o mesmo pedido várias vezes", "Usar sempre as frases mais curtas possíveis"], c: 0,
        e: "Persona + exemplos + formato definido = respostas no padrão que você precisa." },
      { p: "Para saber a cotação do dólar de hoje, o ideal é…", o: ["Ativar a pesquisa na web antes de perguntar", "Perguntar direto, o modelo sempre sabe", "Trocar para o modelo Opus", "Criar um Projeto com a cotação"], c: 0,
        e: "O conhecimento do modelo tem data de corte; para informação atual, use a pesquisa na web." },
      { p: "A 'pesquisa profunda' serve para…", o: ["Investigar um tema a fundo e entregar relatório com fontes", "Buscar arquivos guardados no seu celular", "Acelerar as respostas do modelo", "Apagar o histórico de conversas"], c: 0,
        e: "É o modo de pesquisa avançada: o Claude investiga a fundo e devolve um relatório com referências." },
      { p: "A 'memória' do Claude serve para…", o: ["Lembrar informações suas entre conversas (e você controla)", "Gravar a tela do seu aparelho", "Guardar suas senhas com segurança", "Acelerar a sua conexão de internet"], c: 0,
        e: "Ele pode lembrar preferências e contexto entre conversas — com transparência e controle seu." },
      { p: "Você quer que o Claude responda sempre no tom da sua empresa, sem repetir as regras. O que usar?", o: ["Um Projeto com instruções fixas", "Um Artifact com o texto pronto", "A pesquisa na web da empresa", "O modo de voz do aplicativo"], c: 0,
        e: "Projetos guardam instruções fixas que valem para todas as conversas daquele tema." },
      { p: "Você pede 'crie uma calculadora de orçamento interativa'. O que aparece?", o: ["Um Artifact: um mini-app funcionando ao lado do chat", "Um conector novo instalado na sua conta", "Um arquivo para baixar e abrir no Excel", "Uma cobrança extra pelo recurso"], c: 0,
        e: "Pedidos de 'produtos prontos' viram Artifacts — editáveis e até compartilháveis." },
      { p: "Qual a forma mais poderosa de fazer o Claude escrever no SEU estilo?", o: ["Colar 2 ou 3 exemplos seus e pedir para seguir o padrão", "Pedir para ele 'caprichar' no texto", "Escrever o pedido em letras maiúsculas", "Repetir o pedido três vezes seguidas"], c: 0,
        e: "Mostrar exemplos reais transfere o estilo melhor do que qualquer descrição." },
      { p: "Quem criou o padrão MCP que conecta IAs a ferramentas?", o: ["A Anthropic", "A Microsoft", "A Google", "A OpenAI"], c: 0,
        e: "A Anthropic criou o MCP, hoje usado pelo mercado inteiro — o 'USB das IAs'." },
      { p: "Você tem um relatório grande e uma tarefa enorme e complexa. Qual modelo encara melhor?", o: ["Opus, especialista em tarefas longas e complexas", "Haiku, por ser o mais rápido", "Sonnet, por ser o mais equilibrado", "Fable, em qualquer tarefa simples"], c: 0,
        e: "Trabalhos longos e complexos são a especialidade do Opus." },
      { p: "Antes de visitar um cliente novo, o que pedir ao Claude?", o: ["Pesquisar a empresa na web e sugerir ganchos de conversa", "Resumir documentos internos do seu computador", "Criar um Artifact com a logo do cliente", "Agendar a reunião na sua agenda"], c: 0,
        e: "Com a pesquisa na web, ele levanta dados recentes do cliente para você se preparar." },
      { p: "Como o Claude pode te ajudar com uma planilha de vendas?", o: ["Você envia o arquivo e ele analisa, acha erros e sugere gráficos", "Você digita os dados de novo no chat, linha a linha", "Ele só abre planilhas se você tiver o plano Max", "Ele edita o arquivo direto no seu computador"], c: 0,
        e: "Envie o arquivo e peça conclusões, inconsistências e visualizações." },
      { p: "Uma boa técnica para tarefas grandes é…", o: ["Pedir em etapas: primeiro a estrutura, depois cada parte", "Pedir tudo pronto de uma vez só", "Escrever o pedido em uma única palavra", "Trocar de conversa a cada parágrafo"], c: 0,
        e: "Quebrar em etapas e aprovar a estrutura antes garante um resultado muito melhor." },
      { p: "Os conectores acessam suas ferramentas…", o: ["Somente com a sua autorização, e você pode desconectar", "Automaticamente, assim que você instala", "Apenas em computadores com Windows", "Sem aparecer nas configurações da conta"], c: 0,
        e: "Você autoriza cada conector e pode revogar o acesso quando quiser." },
    ],
    quiz3: [
      { p: "O que o Claude Code faz que o chat do claude.ai NÃO faz sozinho?", o: ["Lê e edita seus arquivos, roda comandos e testa o resultado", "Conversa em linguagem natural e responde perguntas", "Analisa um PDF ou imagem que você anexa", "Lembra as suas preferências entre conversas"], c: 0,
        e: "Os três últimos o chat também faz. O diferencial do Claude Code é AGIR: editar arquivos e rodar comandos — com sua aprovação." },
      { p: "Como se instala o Claude Code?", o: ["Pelo terminal: npm install -g @anthropic-ai/claude-code", "Baixando o app na App Store", "Pedindo a instalação no chat do claude.ai", "Já vem instalado junto com o Windows"], c: 0,
        e: "Com Node.js instalado: npm install -g @anthropic-ai/claude-code, depois rode 'claude' na pasta do projeto." },
      { p: "Para que serve o arquivo CLAUDE.md?", o: ["É o 'manual do projeto' que o Claude lê a cada sessão", "Um arquivo de backup do seu código", "O lugar onde se guardam as senhas do projeto", "A lista de erros encontrados pelo Claude"], c: 0,
        e: "O /init cria o CLAUDE.md com convenções e comandos do projeto — contexto permanente." },
      { p: "Na API, você paga…", o: ["Por milhão de tokens de entrada e de saída", "Uma assinatura mensal fixa", "Por hora de uso do modelo", "Uma única taxa de licença"], c: 0,
        e: "API é pagamento por uso: ex. Sonnet 4.6 custa US$ 3 (entrada) / US$ 15 (saída) por milhão de tokens." },
      { p: "O que oferece 50% de desconto na API?", o: ["O Batch API, para tarefas que podem esperar", "Um cupom de desconto de primeiro uso", "Pagar a fatura em dólar", "Fazer as chamadas de madrugada"], c: 0,
        e: "O processamento em lote (Batch) custa metade do preço para tarefas que podem esperar." },
      { p: "O 'cache de prompt' da API serve para…", o: ["Baratear (até ~90%) o contexto que se repete a cada chamada", "Salvar as suas conversas no histórico", "Aumentar a velocidade da sua internet", "Esconder dados sensíveis do modelo"], c: 0,
        e: "Contexto repetido (instruções, documentos) é cacheado e cobrado muito mais barato nas chamadas seguintes." },
      { p: "Um 'servidor MCP' é…", o: ["Um programa que expõe ferramentas e dados para a IA usar", "Um computador mantido pela Anthropic", "Um plano corporativo (Enterprise)", "Um antivírus para proteger a conta"], c: 0,
        e: "Servidores MCP oferecem ferramentas (ações) e recursos (dados); o Claude é o cliente que os consome." },
      { p: "O que é um 'agente' de IA?", o: ["Uma IA que persegue um objetivo: planeja, age e verifica", "Um funcionário da Anthropic que ajuda você", "Um atalho de teclado do aplicativo", "Um tipo de vírus que imita a IA"], c: 0,
        e: "Agentes não só respondem: trabalham até concluir a tarefa, usando ferramentas e se auto-corrigindo." },
      { p: "Subagentes servem para…", o: ["Dividir um trabalho grande em ajudantes que rodam em paralelo", "Vigiar o que o usuário está fazendo", "Traduzir a resposta para outro idioma", "Economizar a bateria do aparelho"], c: 0,
        e: "O Claude despacha 'ajudantes' em paralelo: um pesquisa, outro escreve, outro revisa." },
      { p: "Qual prática de segurança está ERRADA?", o: ["Colocar a chave da API dentro do código publicado", "Revisar os documentos importantes antes de enviar", "Dar a conectores apenas as permissões mínimas", "Conferir os números que a IA gerou"], c: 0,
        e: "Chave de API é segredo: use variáveis de ambiente e nunca exponha no código." },
      { p: "Você quer automatizar a organização de centenas de arquivos no PC. Qual ferramenta?", o: ["O Claude Code, que age no seu computador", "O chat do claude.ai no navegador", "A pesquisa na web da Anthropic", "Um Artifact gerado na conversa"], c: 0,
        e: "O Claude Code executa ações no seu computador — perfeito para automatizar tarefas." },
      { p: "Antes de o Claude Code executar uma ação importante, o que acontece?", o: ["Ele mostra o que vai fazer e pede a sua aprovação", "Ele executa direto, sem avisar", "Ele reinicia o computador por segurança", "Ele pede a sua senha de administrador"], c: 0,
        e: "Você sempre aprova as ações importantes antes de ele executar." },
      { p: "O que você precisa instalar antes do Claude Code?", o: ["O Node.js", "Um pacote de antivírus pago", "O Microsoft Office completo", "Uma placa de vídeo dedicada"], c: 0,
        e: "Com o Node.js instalado, rode: npm install -g @anthropic-ai/claude-code." },
      { p: "Sua empresa tem milhares de tarefas iguais por mês, sem pressa. O que reduz o custo na API pela metade?", o: ["Usar o Batch API (processamento em lote)", "Pagar a fatura em dólar", "Rodar as tarefas de madrugada", "Trocar a senha da conta toda semana"], c: 0,
        e: "O Batch processa em lote com 50% de desconto para tarefas que podem esperar." },
      { p: "Você manda sempre o mesmo manual gigante em cada chamada da API. O que barateia isso?", o: ["O cache de prompt", "Apagar o manual da chamada", "Trocar para o modelo Haiku", "Dividir o manual em vários arquivos"], c: 0,
        e: "O cache de prompt reaproveita o conteúdo repetido, cobrando até 90% mais barato." },
      { p: "Pense em 'funcionários digitais' cuidando de tarefas repetitivas sozinhos. Isso é…", o: ["Um agente de IA", "Um conector de ferramenta", "Um Artifact interativo", "Uma janela de contexto"], c: 0,
        e: "Agentes executam objetivos: planejam, usam ferramentas e se corrigem até concluir." },
      { p: "Uma 'Skill' no Claude é…", o: ["Uma 'apostila' que ensina o Claude a fazer algo do seu jeito", "Um plano pago com recursos extras", "Um mini-jogo de treino do curso", "Um conector para apps externos"], c: 0,
        e: "Skills dão ao Claude instruções e exemplos do seu padrão, que ele usa quando a tarefa pede." },
      { p: "Pode mandar dados de clientes para a IA?", o: ["Só conforme a política da empresa e a LGPD", "Sempre, sem qualquer limite", "Nunca, em hipótese alguma", "Apenas com o plano Enterprise"], c: 0,
        e: "Dados sensíveis seguem a política da empresa e a LGPD. Senhas e chaves, jamais." },
      { p: "Por que só instalar servidores MCP de fontes confiáveis?", o: ["Porque eles executam ações reais nas suas contas e no PC", "Porque os de fontes ruins gastam mais internet", "Porque só os confiáveis deixam o app bonito", "Porque os outros são mais lentos para responder"], c: 0,
  ...
  const OFICINA = [
    { c: "Você precisa cobrar um cliente sem estragar a relação.",
      ...
      o: ["Escreva um e-mail cordial cobrando a fatura vencida há 15 dias do cliente Silva, preservando a relação. Máximo 6 linhas.",
          "Escreva um e-mail de cobrança educado para um cliente que está atrasado.",
          "Escreva um e-mail firme cobrando o cliente Silva, que não pagou a fatura."],
      r: 0, e: "Contexto (15 dias, cliente Silva), objetivo (preservar a relação) e formato (6 linhas) vencem. 'Educado' e 'firme', sem detalhes, geram texto genérico." },
    { c: "Você quer um post para o Instagram da empresa.",
      f: "faz um post",
      o: ["Crie 3 legendas para Instagram sobre [produto], público jovem, tom divertido, 1 emoji e chamada para ação no fim.",
          "Crie uma legenda divertida de Instagram para o nosso produto.",
          "Escreva um post de Instagram para vender o [produto] aos clientes."],
      r: 0, e: "3 opções dão escolha; público, tom, formato e CTA definidos acertam de primeira. Sem isso, sai genérico." },
    { c: "Você recebeu uma planilha gigante de vendas para analisar.",
      f: "analisa essa planilha",
      o: ["Analise esta planilha de vendas e dê: as 3 principais conclusões, números fora do padrão e a região que precisa de atenção. É para a diretoria.",
          "Analise esta planilha de vendas e me diga os pontos mais importantes.",
          "Faça um resumo completo dos dados desta planilha de vendas."],
      r: 0, e: "Dizer O QUE você quer (3 conclusões, alertas) e PARA QUE (diretoria) transforma a resposta. 'Importante' e 'completo' deixam a IA adivinhar." },
    { c: "Você quer aprender um assunto difícil do zero.",
      f: "me explica física quântica",
      o: ["Explique física quântica como se eu tivesse 12 anos, com analogias do dia a dia, e depois me faça 3 perguntas para testar.",
          "Explique física quântica de um jeito bem fácil de entender.",
          "Me dê uma introdução simples e didática à física quântica."],
      r: 0, e: "Definir o nível (12 anos), pedir analogias e um teste no fim é o método do professor particular. 'Fácil' e 'didático' são vagos." },
    { c: "Você precisa preparar uma reunião importante amanhã.",
      f: "me ajuda com a reunião",
      o: ["Tenho reunião amanhã com [cliente] sobre [assunto]. Monte: agenda de 30 min, 3 perguntas-chave e possíveis objeções com respostas.",
          "Me ajude a preparar uma reunião importante que tenho amanhã.",
          "Monte um roteiro para uma reunião de negócios com um cliente."],
      r: 0, e: "Contexto (quem, sobre o quê) + entregáveis claros (agenda, perguntas, objeções) = reunião pronta em 2 minutos." },
    { c: "A primeira resposta veio boa, mas longa demais.",
      f: "(você quer encurtar sem perder o conteúdo)",
      o: ["Ficou ótimo, mas está longo. Reduza para 3 parágrafos mantendo os números e o tom.",
          "Resume isso aí para ficar mais curto, por favor.",
          "Refaça esse texto deixando ele bem menor."],
      r: 0, e: "Iterar com instrução específica (o que manter, qual tamanho) aproveita o que já estava bom. 'Resume' e 'refaz' jogam fora detalhes." },
    { c: "Você quer ideias para o aniversário da sua mãe.",
      f: "ideias de presente",
      o: ["Minha mãe faz 60 anos, ama jardinagem e café, orçamento de R$ 200. Dê 5 ideias de presente, da mais segura à mais ousada.",
          "Me dê ideias de presente de aniversário para a minha mãe.",
          "Sugira presentes criativos para uma mãe que gosta de jardinagem."],
      r: 0, e: "Detalhes pessoais (idade, gostos, orçamento) e o critério de ordenação transformam ideias genéricas em certeiras." },
    { c: "Você quer que o texto saia no estilo da sua empresa.",
      f: "escreve no nosso estilo",
      o: ["Aqui vão 2 exemplos de textos nossos: [cola]. Escreva o novo comunicado seguindo exatamente este estilo e tom.",
          "Escreva no mesmo estilo que a nossa empresa costuma usar.",
          "Faça um texto com um tom profissional parecido com o nosso."],
      r: 0, e: "Mostrar exemplos reais é a forma mais poderosa de transferir estilo — vale mais que descrever 'nosso tom'." },
  ];
